...
<head>
    ...
    <title>Profile - Urban Bank Ltd - 2024</title>
            ...
            <div class="nav-container">
                <a class="navbar-brand" href="./index.php">
                    <div class="sidebar-brand-icon rotate-n-15">
                        <img src="../../assets/img/Urban-logo2.png" height="50px">
                    </div>
                    <div class="sidebar-brand-text"><span>Urban Bank Ltd - 2024</span></div>
                </a>
